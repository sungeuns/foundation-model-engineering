...
## The Open-Model Frontier: Architecture Versus Disclosure

**Evidence snapshot: September 15, 2026.**
...
| Model | Public state on September 15, 2026 | Verified architectural disclosure | What is still unknown |
| :--- | :--- | :--- | :--- |
...
| Kimi K3 | Released/open-weight; weights, technical report, MoonEP, FlashKDA, and AgentEnv are public [[14]](#ref-14) | 2.8T parameters, native multimodality, 1M context, Kimi Delta Attention, Attention Residuals, Stable LatentMoE, and 16-of-896 expert routing [[11]](#ref-11) [[14]](#ref-14) | The exact pre-training data mixture and complete filtering recipe remain undisclosed |
...
| Qwen3.8-Max | Released/open-weight as Qwen3.8-2.4T-A95B [[15]](#ref-15) | Public weights and configuration establish 2.4T total parameters, 95B active parameters, and 1M context [[13]](#ref-13) [[15]](#ref-15) | The exact corpus mixture and complete data-filtering and post-training recipes remain undisclosed |
...
### Qwen3.8: artifact arrival changes the claim boundary

Qwen3.8 is valuable precisely because its release history teaches evidence discipline. At preview time, Alibaba had announced a 2.4T model and future open weights, so its internals had to remain **undisclosed** rather than inherit Qwen3.7 details [[13]](#ref-13). The later Qwen3.8-2.4T-A95B repository changed that boundary: weights and configuration now support claims about total and active parameters and the 1M context window [[15]](#ref-15). They still do not disclose the exact corpus mixture or complete filtering and post-training recipes. A living technical comparison must change when the artifact changes—not when a future promise is first published.
...
14. <a id="ref-14"></a>Moonshot AI. (2026). *Kimi K3 Open Day: weights, technical report, and infrastructure*. [Kimi](https://www.kimi.com/news/kimi-k3-open-source).
15. <a id="ref-15"></a>Qwen Team. (2026). *Qwen3.8-2.4T-A95B*. [Hugging Face model repository](https://huggingface.co/Qwen/Qwen3.8-2.4T-A95B).
